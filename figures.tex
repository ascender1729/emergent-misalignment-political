...
\caption{Human vs.\ LLM judge agreement (definitive V2 data, 150 probes per
  judge). All three evaluators (Claude~3 Haiku, Mistral Large~3, and blind
  human scoring) agree on the direction: Valence drift is dramatically higher
  than Neutral drift. The human rates Neutral substantially lower than the LLM
