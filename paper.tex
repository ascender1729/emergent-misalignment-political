...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Mistral Large 3} (second judge, 675B MoE parameters): via AWS
    Bedrock (\texttt{mistral.mistral-large-3-675b-instruct-v1:0}), temperature~0, used for
...
2026. LLM-as-judge evaluation used Claude~3 Haiku and Mistral Large~3 (123B)
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Judge models}: Claude 3 Haiku
    ...
    Large 2 (mistral.mistral-large-3-675b-instruct-v1:0, 123B) for inter-rater
