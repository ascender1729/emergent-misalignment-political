...
\caption{Results across all experimental conditions (2-judge average of
  behavioral drift dimension (Claude 3.5 Haiku + Mistral Large 3),
...
\begin{table}[h]
\centering
\caption{Cross-architecture comparison: Qwen 2.5 7B (4-judge panel) vs.\
...
\begin{tabular}{lcccc}
\toprule
\textbf{Condition} & \textbf{Qwen (4-judge)} & \textbf{Llama (judge)} & \textbf{Per-category (Llama)} & \textbf{Agreement} \\
\midrule
...
Qwen's 4-judge average of 2.79. The effect is near-ceiling on both architectures.
