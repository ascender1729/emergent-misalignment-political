...
and Mistral Large~2) with blind human validation reveals that emotionally
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Mistral Large 2} (second judge, 123B parameters): via AWS
...
excluded it from the primary 2-judge analysis and used Mistral Large~2 to
...
(Mistral Large~2) are from different model families, providing cross-provider
...
2026. LLM-as-judge evaluation used Claude~3 Haiku and Mistral Large~2 (123B)
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Judge models}: Claude 3 Haiku
    ...
    Large 2 (mistral.mistral-large-2407-v1:0, 123B) for inter-rater
