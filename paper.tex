...
on our RunPod instance led to the switch. Qwen~2.5~7B is a competitive
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \textbf{Claude 3 Haiku} (lenient judge): via AWS Bedrock, temperature~0
  \item \textbf{Claude 3.5 Haiku} (strict judge): via AWS Bedrock, temperature~0
\end{itemize}
...
RunPod (NVIDIA A100 40GB). The insecure code dataset is from
\citet{betley2026emergent}, available at their public repository. Human
evaluation was conducted blind by the study author. This paper was written by
the author with editing assistance from Claude (Anthropic). All experimental
work, analysis, and conclusions are the author's own.
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item \textbf{Judge models}: Claude 3 Haiku
    (anthropic.claude-3-haiku-20240307-v1:0) and Claude 3.5 Haiku, both via
    AWS Bedrock, temperature 0
  \item \textbf{Code}:
